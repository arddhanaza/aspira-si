            ...
            <div class="col-md-6 align-self-center">
                <div class="card rounded text-center" style="width: 18rem;">
                    <div class="card-body" style="padding-bottom: 30%;">
                        ...
                        <p>Don't worry! Just fill in NIM and full name check and give you a chance to reset your password.<br><br>
                        </p>
                        ...
                        <form method="POST" action="{{route('validate_lupa_password')}}">
                            ...
                            <div class="form-group text-left">
                                ...
                                <input type="text" class="form-control bg-light" id="nama_mahasiswa" name="nama_mahasiswa" required>
                            </div>
